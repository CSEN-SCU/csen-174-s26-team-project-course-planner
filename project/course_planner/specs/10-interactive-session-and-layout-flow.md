...
8. When a non-empty gap list exists, show step-two instructions, a preference text area, an optional audio recorder with a transcribe control that appends recognized text into the preference field (network speech service), and a generate button.
